...
/********* INDICATION PROJET BLUETOOTH
 *  COMMANDES UTILISEES POUR CREER UN SERVICE GATT ET LE CHAR ASSOCIE MODIFIABLE PAR LE MODULE FLORA ET READABLE PAR BLUETOOTH 
 *  
 ...
 *  
 *  
 *  https://learn.adafruit.com/adafruit-flora-bluefruit-le/atcommand
 *  https://www.hackster.io/falafel-software/making-a-smart-bracelet-using-custom-btle-gatt-services-3fea6c
 *  
 *  
 */
